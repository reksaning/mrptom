...
class ForecastController extends Controller
{
    ...
    
    {
        ...
        return view('forecasts.index',compact('demand','commodities','packagings', 'forecasts','lastMonth', 'lastMonthNeed', 'leadTime','lastMonthOrder', 'method', 'kebutuhan', 'outlets', 'monthly', 'monthlyKg', 'nama', 'lastMonthOrderKemasan','selisih'));
    }
